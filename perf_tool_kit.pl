...
sub cursor_menu 
	{
		say '---------------------------------------------------------------------------------------------------------';
		say '- Option: CUR for various Cursor script          ';
		say '---------------------------------------------------------------------------------------------------------';
...
do	{
	say ('Enter SUC for for Suppressing Parent Cursor (all childs) (SQL_ID) '); 
	say ('Enter DPC for displaying Cursor-Not-Shared Reason'); 
	...
	elsif ($choice eq 'DPC')
	{
		print("Enter a SQL_ID:\n"); 
		chomp($sql_id = <STDIN>);
		$result_query=exec_sql_one_param($connect_string,'cursor_reason',$sql_id);
		print $result_query;
	}
	
	elsif ($choice eq 'MEMC')
	{
		toto;
	}
