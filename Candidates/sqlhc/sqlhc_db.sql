REM  
REM $Header: sqlhc_db.sql 2024/08/04 $
REM
REM Copyright (c) 2000-2019, Oracle Corporation. All rights reserved.
REM
REM NAME
REM   sqlhc_db.sql SQL Health-Check script for the database 
REM
REM DESCRIPTION
REM   Produces multiple HTML/Text reports with a list of observations and other information 
REM   based on health-checks performed in and around the database
REM
REM   Inputs: License Parameter
REM
REM NOTES
REM 
...
REM
REM   1. For possible errors see sqlhc_db.log.
...
REM   SQL> START [path]sqlhc.sql [T|D|N] ""
REM   SQL> START sqlhc.sql T ""
REM
Rem    MODIFIED   (MM/DD/YY)
Rem    smuthuku    10/09/24 - SQLHC version update ER 37154785
REM    scharala    03/08/24 - Created
...
REM
DEF script = 'sqlhc_db';
DEF parent_script = 'sqlhc';
DEF method = 'SQLHC_DB';
DEF mos_doc = '1366133.1';
DEF doc_ver = '23.1';
DEF doc_date = '2024/07/06';
...
SELECT '^^script._^^time_stamp._'||'DB_MODE' files_prefix FROM DUAL;
...
PRO ^^doc_ver. Report: ^^files_prefix._1_main.html</h1>
PRO
PRO <a name="toc"></a> 
...
SELECT
  ...
  '</tr>'
  FROM dba_advisor_parameters where owner='SYS' and task_name='SYS_AUTO_SPM_EVOLVE_TASK' 
  and parameter_value !='UNUSED' order by rownum, parameter_name;
PRO <tr>
PRO <th>#</th>
PRO <th>OWNER</th>
PRO <th>TASK ID</th>
...
HOS zip -m ^^files_prefix._9_log.zip ^^parent_script..log
